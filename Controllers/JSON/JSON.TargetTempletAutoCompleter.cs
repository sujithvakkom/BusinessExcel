...
namespace BusinessExcel.Controllers.JSON
{
    public partial class JSONController : Controller
    {
        ...
        public JsonResult TargetTempletAutoCompleter(String Search,int Page, string Extra)
        {
            JsonResult res = null;
            ...
            using (var db = new SalesManageDataContext()) {
                ...
                var items = db.getTargetTempletDetails(search: Search, 
                    PageNum: Page,PageSize:null,
                    RowCount:out temp,
