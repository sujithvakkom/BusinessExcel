...
! function (e) {
    function t() {
        e[n].glbl || (r = {
            ...
            return "sb-" == e.slice(0, 3) && (e = e.slice(3)), e
        }, a.mm = function (e) {
            return "sb-" + e
    ...
    if (!(e[n] && e[n].version > s)) {
        e[n] = function (e, t, n) {
            ...
            _initMenu: function () {
                ...
                var t = [i.menu];
                this.opts.slidingSubmenus || t.push(i.vertical), this.opts.extensions = this.opts.extensions.length ? "sb-" + this.opts.extensions.join(" sb-") : "", this.opts.extensions && t.push(this.opts.extensions), this.$menu.addClass(t.join(" "))
            },
