...
namespace BusinessExcel.Providers.ProviderContext
{
    ...
    public partial class SalesManageDataContext : DbContext
    {
        ...
        public virtual List<CategoryAchievement> getCategoryAchievement(int pageNumber, int? pageSize, string sort, String sortdir, out int count)
        {
            ...
            try
            {
                items = this.Database.SqlQuery<CategoryAchievement>(
                                                "[sc_salesmanage_merchant].[getCategoryAchievement] @page_number, @page_size, @row_count OUTPUT", page_number, page_size, row_count)
                                                .ToList();
